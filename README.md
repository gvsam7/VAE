...
The first model is a variational autoencoder comprised of convolutional, batch normalisation and max pooling layers.
The second model is comprised of a Gabor convolutional layer, followed by normal convolutional, batch normalisation and mix pooling layers.
The purpose of this code is to become a testing platform where various Variational Encoder generative models will be tested in both colour and grey scale images.
